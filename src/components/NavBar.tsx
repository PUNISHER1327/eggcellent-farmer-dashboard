...
const NavBar: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto flex items-center justify-between py-4">
          <div className="flex items-center space-x-2">
            ...
            <span className={`text-xl font-bold ${theme === 'light' ? 'text-gradient-light' : 'text-gradient'} tracking-tight`}>Farmer Friendly</span>
          </div>
          ...
          <div className="hidden md:flex space-x-8">
            {['Home', 'Live Data', 'Insights', 'Contact'].map((item, index) => (
              <a 
                ...
                className={`${theme === 'light' ? 'text-gray-800/90' : 'text-white/80'} hover:text-farm-green transition-colors duration-300 relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-farm-green after:transition-all after:duration-300`}
          ...
          <div className="flex items-center space-x-4">
            <HoverCard>
              ...
              <HoverCardContent className={theme === 'light' ? 'light-glass-morphism border-gray-200' : 'glass-morphism border-white/10'}>
      ...
      {/* Mobile menu */}
      <div 
        className={`fixed inset-0 z-30 ${theme === 'light' ? 'bg-white/90' : 'bg-black/90'} backdrop-blur-md transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="container mx-auto h-full flex flex-col justify-center items-center space-y-8">
          ...
          <Button 
            className="mt-6 bg-farm-green hover:bg-farm-green/80"
          >
            Dashboard
          </Button>
        </div>
